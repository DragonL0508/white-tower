...
#name ID
data merge storage hostile:this {id:"1_boss"}

#display name
data merge storage hostile:this {name:"[{\"text\":\"信仰使徒 \",\"color\":\"#FFFFC4\",\"bold\": true},{\"text\":\"札爾修斯\",\"color\":\"#FFFFC4\",\"bold\": true}]"}
...
#movement speed
data merge storage hostile:this {speed:0.27}
...
data merge storage hostile:this {bossbar_text:"§f§l信仰使徒 §e§l札爾修斯"}
