...
#name ID
data merge storage hostile:this {id:"1_riysin"}

#display name
data merge storage hostile:this {name:"{\"text\":\"Riysin\",\"color\":\"yellow\"}"}

#health
data merge storage hostile:this {health:10}

#attack damage
data merge storage hostile:this {atk:10}
...
data merge storage hostile:this {bossbar_text:"中文測試"}
