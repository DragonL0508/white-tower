...
#name ID
data merge storage hostile:this {id:"1_magician_vex"}
...
data merge storage hostile:this {ability_cd:60}
...
#details
    #mob type
    data merge storage hostile:this {type:"minecraft:vex"}
    ...
    #mainhand
    data merge storage hostile:this {mainhand:"minecraft:firework_star"}
