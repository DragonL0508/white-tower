...
#boss
execute if entity @s[tag=boss] if score @s invincible matches 1.. run bossbar set boss_health color blue
execute if entity @s[tag=boss] unless score @s invincible matches 1.. run bossbar set boss_health color white