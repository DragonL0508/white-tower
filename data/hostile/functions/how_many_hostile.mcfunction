...
function hostile:is_target with storage hostile.list.cache
...
$execute if data storage minecraft:hostile.list.cache list[$(counter)] run function hostile:how_many_hostile with storage hostile.counter.cache