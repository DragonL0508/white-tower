...
data modify storage npc:village magic.Buy append value {buy:{Name:"quest:demo/demo_currency",Count:12b},sell:{Name:"quest:demo/mysterious_stone",Count:1b},maxUses:2147483647}
# ...
