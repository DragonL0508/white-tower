...
execute if data storage endsky_npc:trader Interpret.Item.buy.tag run data modify storage endsky_npc:trader Interpreted.Sell[-1].buy.tag set from storage endsky_npc:trader Interpret.Item.buy.tag
...
execute if data storage endsky_npc:trader Interpret.Item.buyB.tag run data modify storage endsky_npc:trader Interpreted.Sell[-1].buyB.tag set from storage endsky_npc:trader Interpret.Item.buyB.tag
...
execute if data storage endsky_npc:trader Interpret.Item.sell.tag run data modify storage endsky_npc:trader Interpreted.Sell[-1].sell.tag set from storage endsky_npc:trader Interpret.Item.sell.tag
