...
execute as @a[team=intower] at @s run playsound ui.button.click master @s ~ ~ ~ 1 2 1
...
#messages
#execute if score timer tower matches 0 run title @a[team=intower] subtitle {"text": "關卡開始"}
