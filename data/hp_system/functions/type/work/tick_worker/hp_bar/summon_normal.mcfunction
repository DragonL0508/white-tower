...
summon text_display ~ ~2.4 ~ {teleport_duration:0,billboard:"center",alignment:"center",Tags:["hp_bar","normal","newest"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.4f,0f],scale:[1f,1f,1f]},text:'{"text":""}'}
